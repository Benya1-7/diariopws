...
public class EliminarFile {
 ...
 public static boolean delete_imageperfil(String idusuario)throws SQLException, Exception {
     try{ 
     String foto="";
  ...
  public static boolean delete_imageportada(String idusuario)throws SQLException, Exception {
     try{ 
     String foto="";
      OperacionBD.iniciaroperacion();
 ...
 /*
   List<Parametro> parametros= new  ArrayList<>();
      ...
      OperacionBD.confirmaroperacion();
 */
  public static boolean checkfile(String namefile, InputStream archivo){
      String nombrearchivo=namefile;
          
    String sFichero = SaveDownloadFile.RUTA+nombrearchivo;
...
if (!fichero.exists())
{
  ...
  try {
              guardar(archivo, nombrearchivo);
          } catch (IOException ex) {
              Logger.getLogger(EliminarFile.class.getName()).log(Level.SEVERE, null, ex);
          }
return true;
  }
